...
def render_handover_document(
    ...
    blocks = []
    if handover_nurse:
        blocks.append(f"**Generated by AI for:** {handover_nurse}")
    if generated_at is not None:
        stamp = generated_at if generated_at.tzinfo else generated_at.replace(tzinfo=timezone.utc)
        blocks.append(f"**Generated at:** {stamp.astimezone(timezone.utc).isoformat()}")
